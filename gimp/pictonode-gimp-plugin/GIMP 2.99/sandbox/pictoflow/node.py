...
class Node(Gtk.Box):
    ...
    def do_realize(self):
        ...
        self.attr.event_mask  = (Gdk.EventMask.BUTTON_PRESS_MASK | Gdk.EventMask.BUTTON_RELEASE_MASK | Gdk.EventMask.POINTER_MOTION_MASK | Gdk.EventMask.TOUCH_MASK | Gdk.EventMask.ENTER_NOTIFY_MASK | Gdk.EventMask.LEAVE_NOTIFY_MASK)
    ...
    def draw_frame(self, cr, allocation):
        ...
        Gtk.render_background(c, cr, allocation.x, allocation.y, allocation.width, allocation.height)
        Gtk.render_frame(c, cr, allocation.x, allocation.y, allocation.width, allocation.height)
